...
public class MealsServiceImpl implements MealsService {
  ...
  public DataBean getLstOrderByDepart(Integer userId, String date) {
    ...
    Date dateTime =
        FunctionUtils.convertDateByFormatLocal(date, ConstanKey.FORMAT_DATE.DATE_TIME_FORMAT);
  ...
  public DataBean getLstByDate(String fromDate, String toDate) {
    ...
    List<MealsOrderBean> lstOder = new ArrayList<>();
    Date fromTime =
        FunctionUtils.convertDateByFormatLocal(fromDate, ConstanKey.FORMAT_DATE.DATE_TIME_FORMAT);
    Date toTime =
        FunctionUtils.convertDateByFormatLocal(toDate, ConstanKey.FORMAT_DATE.DATE_TIME_FORMAT);
  ...
  @Override
  public Boolean saveCateringEmployee(List<MealsOrderBean> listMealOder, String fromDate,
      String toDate) {
    Date fromTime =
        FunctionUtils.convertDateByFormatLocal(fromDate, ConstanKey.FORMAT_DATE.DATE_TIME_FORMAT);
    Date toTime =
  ...
  @Override
  public Boolean saveCateringByManager(Integer departId, List<MealsOrderBean> listMealOder,
      String date) {
    Date cateringDate =
        FunctionUtils.convertDateByFormatLocal(date, ConstanKey.FORMAT_DATE.DATE_TIME_FORMAT);
  ...
  private List<MealTimeBean> getAllMealTime() {
    ...
    if (lst != null && !lst.isEmpty()) {
      for (MealTime obj : lst) {
        list.add(
            new MealTimeBean(obj.getMealTimeId(), obj.getMealTimeName(), obj.getDescription()));
      }
    }
    return list;
  }
